      ...
      <div class="col-md-8 col-lg-9 admin-main">
        ...
        <div class="col-md-12">
          <div class="card mb-3">
            ...
            <div class="card-body">
            <b-card header="Tambah Jumlah Penduduk Berdasarkan Jenis Pekerjaan" header-tag="h4" class="bg-success-card">
...
miniToastr.init();
export default {
    name: "jumlah_penduduk_jenis_pekerjaan_add",
    components: {
        Datepicker
    },
    data() {
        return {
            jumlah_penduduk_jenis_pekerjaans: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/jumlah-penduduk-jenis-pekerjaan/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/jumlah-penduduk-jenis-pekerjaan/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/jumlah-penduduk-jenis-pekerjaan/create'
                  }
                },
                window.location.href = '#/admin/jumlah-penduduk-jenis-pekerjaan/create')
        ...
        back() {
            window.location = '#/admin/jumlah-penduduk-jenis-pekerjaan';
        }
    },
    mounted: function() {
        axios.get("/jumlah-penduduk-jenis-pekerjaan/create").then(response => {
