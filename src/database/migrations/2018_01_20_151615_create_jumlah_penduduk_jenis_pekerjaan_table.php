...
class CreateJPJenisPekerjaanTable extends Migration {

	public function up()
	{
		Schema::create('jumlah_penduduk_jenis_pekerjaans', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('jumlah_penduduk_jenis_pekerjaans');
	}
}